...
public class WidgetUtil {
    ...
    public static void disableBrowserAutocomplete(TextBox textBox) {
        // Haulmont API
        disableBrowserAutocompleteInternal(textBox);
    }

    // Haulmont API
    public static void disableBrowserAutocomplete(TextBoxBase textBox) {
        disableBrowserAutocompleteInternal(textBox);
    }

    // Haulmont API
    public static void disableBrowserAutocompleteInternal(TextBoxBase textBox) {
        /*-
