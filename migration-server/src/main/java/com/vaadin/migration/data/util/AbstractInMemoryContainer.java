 ...
 * the License.
 */
package com.vaadin.migration.data.util;
...
import com.vaadin.migration.data.util.filter.SimpleStringFilter;
import com.vaadin.migration.data.util.filter.UnsupportedFilterException;
