...
public class Grid<T> extends ResizeComposite implements HasSelectionHandlers<T>,
        ...
        private final class DefaultTextRenderer implements Renderer<Object> {
            ...
            public void render(RendererCellReference cell, Object data) {
                if (!warned && !(data instanceof String)) {
                    getLogger().warn(Column.this.toString() + ": "
     ...
     * Haulmont API.
     * <p>
     * Public method for accessing {@link #focusCell(int, int)} method.
     */
    public void focusBodyCell(int rowIndex, int columnIndexDOM) {
        focusCell(rowIndex, columnIndexDOM);
    }
