...
import com.vaadin.migration.client.ui.text.VTextField;
...
public class VScrollTable extends FlowPanel
    ...
    public class TableHead extends Panel implements ActionOwner {
        ...
        // Haulmont API
        public List<Widget> getVisibleCells() {
            return visibleCells;
        }
    ...
    public class TableFooter extends Panel {
        ...
        List<Widget> visibleCells = new ArrayList<Widget>();
        // Haulmont API dependency
        protected Map<String, FooterCell> availableCells = new HashMap<String, FooterCell>();
                                    ...
                                    if ((event.getCtrlKey()
                                        ...
                                        if (!currentlyJustThisRowSelected) {
                                            ...
                                            toggleSelection();
                                                ...
                                                // Haulmont API
                                                && nullSelectionAllowed && isAllowSingleSelectToggle()) {
                                            toggleSelection();
                                        } /*
            ...
            protected Element getElementTdOrTr(Element element) {
                ...
                if (widget != this) {
                    ...
                    if (!(widget instanceof VLabel)
                            ...
                            && !(widget instanceof com.vaadin.migration.client.ui.text.VTextField
