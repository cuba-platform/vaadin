 ...
 * the License.
 */
package com.vaadin.migration.client.ui;
...
import com.vaadin.migration.client.ui.calendar.schedule.CalendarDay;
import com.vaadin.migration.client.ui.calendar.schedule.CalendarEvent;
import com.vaadin.migration.client.ui.calendar.schedule.DayToolbar;
import com.vaadin.migration.client.ui.calendar.schedule.MonthGrid;
import com.vaadin.migration.client.ui.calendar.schedule.SimpleDayCell;
import com.vaadin.migration.client.ui.calendar.schedule.SimpleDayToolbar;
import com.vaadin.migration.client.ui.calendar.schedule.SimpleWeekToolbar;
import com.vaadin.migration.client.ui.calendar.schedule.WeekGrid;
import com.vaadin.migration.client.ui.calendar.schedule.WeeklyLongEvents;
import com.vaadin.migration.client.ui.calendar.schedule.dd.CalendarDropHandler;
...
public class VCalendar extends Composite implements VHasDropHandler {
    ...
    protected boolean isRepaint() {
        return (weekGrid == null) || (outer.getWidgetIndex(weekGrid) == -1);
    }
